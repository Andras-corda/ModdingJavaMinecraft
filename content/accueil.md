...
- **Modélisation & texturing** : [Blockbench (prise en main)](#/blockbench-prise-en-main), [pixel art & textures](#/pixel-art-textures), [Blockbench : blocs & items](#/blockbench-blocs-items), [Blockbench : entités & GeckoLib](#/blockbench-entites-geckolib), [export & import](#/export-import-modeles).
